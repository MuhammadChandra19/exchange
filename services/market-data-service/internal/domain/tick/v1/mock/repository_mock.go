...
import (
	...
	v1 "github.com/muhammadchandra19/exchange/services/market-data-service/internal/domain/tick/v1"
)
...
func (m *MockTickRepository) GetByFilter(ctx context.Context, filter v1.TickFilter) ([]*v1.Tick, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByFilter", ctx, filter)
	ret0, _ := ret[0].([]*v1.Tick)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockTickRepository) GetLatestBySymbol(ctx context.Context, symbol string) (*v1.Tick, error) {
	m.ctrl.T.Helper()
...
func (m *MockTickRepository) Store(ctx context.Context, tick *v1.Tick) error {
	m.ctrl.T.Helper()
...
func (m *MockTickRepository) StoreBatch(ctx context.Context, ticks []*v1.Tick) error {
	m.ctrl.T.Helper()
