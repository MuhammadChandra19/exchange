...
import (
	...
	v1 "github.com/muhammadchandra19/exchange/services/market-data-service/internal/domain/order/v1"
)
...
func (m *MockOrderRepository) GetActiveOrdersBySymbol(ctx context.Context, symbol, side string) ([]*v1.Order, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetActiveOrdersBySymbol", ctx, symbol, side)
...
func (mr *MockOrderRepositoryMockRecorder) GetActiveOrdersBySymbol(ctx, symbol, side interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetActiveOrdersBySymbol", reflect.TypeOf((*MockOrderRepository)(nil).GetActiveOrdersBySymbol), ctx, symbol, side)
}

// GetByFilter mocks base method.
func (m *MockOrderRepository) GetByFilter(ctx context.Context, filter v1.OrderFilter) ([]*v1.Order, error) {
	m.ctrl.T.Helper()
...
func (m *MockOrderRepository) GetByID(ctx context.Context, orderID string) (*v1.Order, error) {
	m.ctrl.T.Helper()
...
func (m *MockOrderRepository) GetEventsByOrderID(ctx context.Context, orderID string) ([]*v1.OrderEvent, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetEventsByOrderID", ctx, orderID)
	ret0, _ := ret[0].([]*v1.OrderEvent)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockOrderRepository) GetOrderBookSnapshot(ctx context.Context, symbol string, depth int) (*v1.OrderBook, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetOrderBookSnapshot", ctx, symbol, depth)
	ret0, _ := ret[0].(*v1.OrderBook)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockOrderRepository) Store(ctx context.Context, order *v1.Order) error {
	m.ctrl.T.Helper()
...
func (m *MockOrderRepository) StoreBatch(ctx context.Context, orders []*v1.Order) error {
	m.ctrl.T.Helper()
...
func (m *MockOrderRepository) StoreEvent(ctx context.Context, event *v1.OrderEvent) error {
	m.ctrl.T.Helper()
...
func (m *MockOrderRepository) StoreEventBatch(ctx context.Context, events []*v1.OrderEvent) error {
	m.ctrl.T.Helper()
