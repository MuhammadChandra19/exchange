...
import (
	...
	v1 "github.com/muhammadchandra19/exchange/services/market-data-service/internal/domain/ohlc/v1"
)
...
func (m *MockOHLCRepository) GetByFilter(ctx context.Context, filter v1.OHLCFilter) ([]*v1.OHLC, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByFilter", ctx, filter)
	ret0, _ := ret[0].([]*v1.OHLC)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockOHLCRepository) GetIntradayData(ctx context.Context, symbol, interval string, limit int) ([]*v1.OHLC, error) {
	m.ctrl.T.Helper()
...
func (m *MockOHLCRepository) GetLatest(ctx context.Context, symbol, interval string) (*v1.OHLC, error) {
	m.ctrl.T.Helper()
...
func (m *MockOHLCRepository) Store(ctx context.Context, ohlc *v1.OHLC) error {
	m.ctrl.T.Helper()
...
func (m *MockOHLCRepository) StoreBatch(ctx context.Context, ohlcs []*v1.OHLC) error {
	m.ctrl.T.Helper()
